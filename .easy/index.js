...
var Router = (function (_KoaRouter) {
    ...
    function Router() {
        ...
        _this.opts.default = _this.opts.default || 'index.js';
...
function OldRouter(options) {
    ...
    if (!_path2.default.isAbsolute(directory)) {
        directory = _path2.default.join(_path2.default.dirname((0, _caller2.default)()), directory);
    }
