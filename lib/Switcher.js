...
class RouterSwitcher extends Switcher {
    match(condition, context) {
        ...
        **/
        ...
        if (!methods.special.includes(condition.method) &&
            methods.request.includes(condition.method) && method !== condition.method) {
            return false;
        }
    ...
    nesting(context) {
        ...
        context.superParams = extend(true, {}, context.params);
        delete context.params;
        context.request = extend(true, {}, context.request);
    ...
    execute(result, context) {
        ...
        request.params = extend(true, {}, context.params);
        return result(...args);
    }
}
